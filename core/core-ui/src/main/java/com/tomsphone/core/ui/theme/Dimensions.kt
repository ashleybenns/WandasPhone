...
object WandasDimensions {
    ...
    val InertBorderBottom = 56.dp  // Extra large at bottom to prevent gesture triggers
    ...
    // End call button (round, smaller than contact buttons)
    val EndCallButtonSize = 100.dp
