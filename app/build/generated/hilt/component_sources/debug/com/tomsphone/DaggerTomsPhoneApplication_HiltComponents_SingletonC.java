...
import com.tomsphone.feature.carer.CarerViewModel;
import com.tomsphone.feature.carer.CarerViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerTomsPhoneApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends TomsPhoneApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(4).add(CarerViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(HomeViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(InCallViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(IncomingCallViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends TomsPhoneApplication_HiltComponents.ViewModelC {
    ...
    private Provider<CarerViewModel> carerViewModelProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.carerViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
      this.homeViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
      this.inCallViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
      this.incomingCallViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
    }

    @Override
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(4).put("com.tomsphone.feature.carer.CarerViewModel", ((Provider) carerViewModelProvider)).put("com.tomsphone.feature.home.HomeViewModel", ((Provider) homeViewModelProvider)).put("com.tomsphone.feature.phone.InCallViewModel", ((Provider) inCallViewModelProvider)).put("com.tomsphone.feature.phone.IncomingCallViewModel", ((Provider) incomingCallViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.tomsphone.feature.carer.CarerViewModel 
          return (T) new CarerViewModel(singletonCImpl.settingsRepositoryImplProvider.get(), singletonCImpl.bindContactRepositoryProvider.get());

          case 1: // com.tomsphone.feature.home.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.settingsRepositoryImplProvider.get(), singletonCImpl.bindContactRepositoryProvider.get(), singletonCImpl.callManagerImplProvider.get(), singletonCImpl.missedCallNagManagerProvider.get(), singletonCImpl.androidTTSImplProvider.get());

          case 2: // com.tomsphone.feature.phone.InCallViewModel 
          return (T) new InCallViewModel(singletonCImpl.callManagerImplProvider.get(), singletonCImpl.bindContactRepositoryProvider.get(), singletonCImpl.bindCallLogRepositoryProvider.get(), singletonCImpl.settingsRepositoryImplProvider.get(), singletonCImpl.androidTTSImplProvider.get());

          case 3: // com.tomsphone.feature.phone.IncomingCallViewModel 
          return (T) new IncomingCallViewModel(singletonCImpl.callManagerImplProvider.get(), singletonCImpl.androidTTSImplProvider.get(), singletonCImpl.ringtonePlayerProvider.get(), singletonCImpl.bindContactRepositoryProvider.get(), singletonCImpl.missedCallNagManagerProvider.get());
  ...
  private static final class ServiceCImpl extends TomsPhoneApplication_HiltComponents.ServiceC {
    ...
    private WandasCallScreeningService injectWandasCallScreeningService2(
      ...
      WandasCallScreeningService_MembersInjector.injectTts(instance, singletonCImpl.androidTTSImplProvider.get());
    ...
    private WandasInCallService injectWandasInCallService2(WandasInCallService instance) {
      ...
      WandasInCallService_MembersInjector.injectTts(instance, singletonCImpl.androidTTSImplProvider.get());
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new MissedCallNagManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.bindCallLogRepositoryProvider.get(), singletonCImpl.bindContactRepositoryProvider.get(), singletonCImpl.settingsRepositoryImplProvider.get(), singletonCImpl.androidTTSImplProvider.get(), singletonCImpl.ringtonePlayerProvider.get());
