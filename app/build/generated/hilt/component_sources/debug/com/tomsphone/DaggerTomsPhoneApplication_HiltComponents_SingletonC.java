...
public final class DaggerTomsPhoneApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends TomsPhoneApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(6).add(CarerViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(EndIncomingCallViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(EndOutgoingCallViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(HomeViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(InCallViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(IncomingCallViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new EndIncomingCallViewModel(singletonCImpl.callManagerImplProvider.get());

          case 2: // com.tomsphone.feature.phone.EndOutgoingCallViewModel 
          return (T) new EndOutgoingCallViewModel(singletonCImpl.callManagerImplProvider.get());
          ...
          return (T) new IncomingCallViewModel(singletonCImpl.callManagerImplProvider.get(), singletonCImpl.androidTTSImplProvider.get(), singletonCImpl.ringtonePlayerProvider.get(), singletonCImpl.bindContactRepositoryProvider.get(), singletonCImpl.missedCallNagManagerProvider.get(), singletonCImpl.settingsRepositoryImplProvider.get());
